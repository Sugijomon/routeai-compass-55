      ...
      {htmlMode ? (
        ...
        <EditorContent
          ...
          className="prose prose-sm max-w-none p-3 min-h-[160px] focus-within:outline-none
            ...
            [&_.ProseMirror_ul]:list-disc [&_.ProseMirror_ul]:pl-5 [&_.ProseMirror_ul]:my-1 [&_.ProseMirror_ul]:list-outside [&_.ProseMirror_ul]:space-y-0
            [&_.ProseMirror_ol]:list-decimal [&_.ProseMirror_ol]:pl-5 [&_.ProseMirror_ol]:my-1 [&_.ProseMirror_ol]:list-outside [&_.ProseMirror_ol]:space-y-0
            [&_.ProseMirror_li]:my-0 [&_.ProseMirror_li]:pl-1 [&_.ProseMirror_li]:leading-snug
            [&_.ProseMirror_li>p]:inline [&_.ProseMirror_li>p]:m-0
